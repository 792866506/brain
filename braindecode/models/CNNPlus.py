...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 10 20:15:05 2017
...
class CNNPlus(object):
    """
    Dense plus for EEG.  plus  the  chnnel  22->30  or  more
    """
    ...
    def create_network(self):
        conv_length = self.first_filter_length
        ...
        if self.split_first_layer:
            ...
            model.add_module('dimshuffle2', Expression(_transpose_time_to_spat))
            model.add_module('expand_channel',
                             nn.Conv2d(self.in_chans, self.chans_2,
                                       kernel_size=(1, 1),
                                       stride=(1, 1),
                                       bias=False))
           
            model.add_module('dimshuffle3', Expression(_transpose_time_to_spat))
        ...
        if self.split_first_layer:
            ...
            init.xavier_uniform(model.expand_channel.weight, gain=1)
...
#aa=CNNPlus(22,4,375).create_network()