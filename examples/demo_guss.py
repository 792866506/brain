...
from braindecode.models.resnet import EEGResNet
...
#        subject_id = 5
       ...
       # train_set, valid_set = split_into_two_sets(train_set,first_set_fraction=0.8)
        valid_set = test_set
        test_set = SignalAndTarget(X[:2],y[0:2])
...
#        exp.run()
        ...
        log.info("\n" + str(1-exp.epochs_df['valid_misclass'].iloc[-10:]))
        acc.append(1-exp.epochs_df['valid_misclass'].iloc[-1])
